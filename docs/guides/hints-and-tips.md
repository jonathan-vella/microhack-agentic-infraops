...
??? note "📄 How Agent Outputs Work (click to reveal)"
...
??? note "💡 Service Selection (click to reveal)"
...
??? note "💰 Cost Optimization (click to reveal)"
...
??? note "🔒 Security & Compliance (click to reveal)"
...
??? note "🔒 Governance Policy Errors (click to reveal)"
...
??? note "🏗️ Bicep Patterns (click to reveal)"
...
??? note "🌍 Multi-Region DR (Challenge 4)"
...
??? note "📚 Documentation (Challenge 6)"
